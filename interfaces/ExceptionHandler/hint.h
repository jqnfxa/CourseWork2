...
const char *hint =
	...
	"\t\t\n"
	"\t\t-c, --color color              color of lines in hex format\n"
	"\t\t\n"
	"\t\t-f, --fill color               (optional) fill color in hex format (by default there is no fill)\n"
	"\t\t\n"
	...
	"\t\t\n"
	"\t\t-c, --color color              specifies color of lines in hex format\n"
	"\t\t\n"
	"\t\t-f, --fill color               (optional) specifies fill color in hex format (by default there is no fill)\n"
	"\t\t\n"
	"\t\t-n, --new <new_filename>.bmp   (optional) if option called then new file will be created instead of rewriting \n"
	"\t\t\t\n"
	"\t\n"
	...
	"\t\t\n"
	"\t\t-c, --color color              specifies color of frame in hex format\n"
	"\t\t\n"
